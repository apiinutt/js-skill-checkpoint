...
//     - โดยที่ Function `authenticateUser` จะมี Variable `validUsername` และ `validPassword` ที่เก็บข้อมูล Username และ Password ที่ถูกต้องเอาไว้
...
//         - Function `authenticateUser` จะ Return ข้อความว่า `"Login failed. Please check your username and password."`
...
function authenticateUser(username, password) {
  ...
  let result
  username == validUsername && password == validPassword ? result = 'Login successful.' : result = 'Login failed. Please check your username and password.'
  return result
}
